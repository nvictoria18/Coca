...
export const framesOfCart = [
  {
    ...
    image: <StyledImg src="/image/image1.png" />,
    icon: <StyledImg className="icon" src="/image/frame1.svg" />
  },
  {
    title: 'Mutually support each other',
    content: 'Build more meaningful and lasting relationships - better understand their needs, identify new opportunities to help address any problems faster',
    image: <StyledImg src="/image/image2.png" />,
    icon: <StyledImg className="icon" src="/image/frame2.svg" />
  },
  {
    title: 'Have fun growing together',
    content: 'Build more meaningful and lasting relationships - better understand their needs, identify new opportunities to help address any problems faster',
    image: <StyledImg src="/image/image3.png" />,
    icon: <StyledImg className="icon" src="/image/frame3.svg" />,
    width: 268,
  },
  {
    title: 'Make Your Business Grow',
    content: 'Build more meaningful and lasting relationships - better understand their needs, identify new opportunities to help address any problems faster',
    image: <StyledImg src="/image/image4.png" />,
    icon: <StyledImg className="icon" src="/image/frame1.svg" />
  },
]